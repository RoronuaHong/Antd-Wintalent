...
export const getSearchComponent = (data, fn, error) => {
    verifyIsLogin(post, "/wt/runner/hunter/auth/position/searchShow", data, fn, error);
...
export const getPostList = (data, fn, error) => {
    verifyIsLogin(post, "/wt/runner/hunter/auth/position/searchData", data, fn, error)
...
export const getPositionList = (data, fn, error) => {
    verifyIsLogin(post, "/wt/runner/hunter/auth/position/list", data, fn, error);
...
export const getName = (data, fn, error) => {
    verifyIsLogin(post, "/wt/runner/hunter/auth/user/getName", data, fn, error)
